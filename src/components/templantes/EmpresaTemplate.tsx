...
export default function EmpresaTemplate() {
  ...
  const inputStyles = "w-full border-4 border-black p-3 font-black text-sm outline-none transition-colors dark:bg-zinc-800 dark:text-white placeholder:text-gray-400 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] focus:shadow-none focus:translate-x-[2px] focus:translate-y-[2px]";
